...
dat_sf_annual<- dat_sf %>%
  group_by(name, year=year(month_year)) %>%
  summarise(kgN_huc8_yr=sum(kgN_huc8,na.rm=T))

#sf::sf_use_s2(FALSE) #turn off the s2 spherical geometry package for geographical coordinate operations
...
bins <- c(814939  ,1409284  ,4741027  ,7245147 ,22427392 )
