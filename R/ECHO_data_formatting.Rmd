...
write.csv(max_vals, file=paste0(here::here(),  "/data/ECHO_data_summarized_maximum_values.csv",row.names = F))
write.csv(min_vals, file=paste0(here::here(),  "/data/ECHO_data_summarized_minimum_values.csv", row.names = F))
write.csv(mean_vals, file=paste0(here::here(),  "/data/ECHO_data_summarized_mean_values.csv", row.names = F))
