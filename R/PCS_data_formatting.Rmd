...
N_load_a<-N_load %>%
   ...
   select(-million_L_per_month,- mg_N_per_L ,- NO3, - NO2, -TKN, -NO2NO3, -state, -`Meas Conc Maxm (MCMX)...16`, -`Meas Conc Maxm (MCMX)...15`) %>%
...
#remove N sum column
N_load_b<- N_load_b %>%
  select(-kg_N_sum_per_month, -permit_outfall_designator, -state)
