...
#removing last three months of CT data which are not included in the rest of the ECHO data
...
dim(N_load_CT_join) #26264
dim(N_load) #8330    
dim(CT_summary) #17934     
length(unique(as.character(N_load_CT_join$permit_outfall))) #151 outfalls with locations
length(unique(as.character(N_load_CT_join$key))) #26264 keys
