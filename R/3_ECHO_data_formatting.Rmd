...
length(unique(as.character(N_load$permit_outfall))) #67 outfalls with/without locations
nrow(N_load) #6856
...
length(unique(as.character(N_load_CT_join$permit_outfall))) #147 outfalls with locations
length(unique(as.character(N_load_CT_join$key))) #23,919 keys
...
#join locations based on permit number and outfall number
dim(N_load_CT_join) #23,919
length(unique(N_load_CT_join$permit_outfall)) #147 outfalls with/without locations
length(unique(N_load_CT_join$key)) #23,919 keys


N_load_out <- left_join(N_load_CT_join, outfall_locations, by = "permit_outfall")
dim(N_load_out) #23,919
length(unique(as.character(N_load_out$permit_outfall))) #147 outfalls with locations
length(unique(as.character(N_load_out$key))) #23,919 keys
...
missing_latitude #4 outfalls missing coordinates
...
dim(N_load_out) #23,919
dim(dat_join) #23,191
length(unique(as.character(dat_join$permit_outfall))) #147 outfalls with locations
length(unique(as.character(dat_join$key))) #23,919 keys
